<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorChangeExcessEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorChangeExcessEndorsement" %>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div runat="server" id="mainDiv">
                        ...
                        <div class="bank_type typ_wrapper" id="ChangeExcessDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">Policy Excess :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                         <asp:TextBox ID="txtOldExcess" runat="server" CssClass="form-control" Enabled="false" />
                                    </div>
                                </div>

                                <div class="form-group col-md-6">
                                   <div class="col-md-4 page-label">
                                        <label class="control-label">New Excess :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                         <asp:TextBox ID="txtNewExcess" runat="server" CssClass="form-control onlynumber" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                            ...
                            <div class="dsc-overallwrapper" id="includeDisc" runat="server" visible="false">
                                <div class="dsc-wrapper">
                                    ...
                                    <div class="form-group col-md-10">
                                        <div class="col-md-4 page-label">
                                            <label class="control-label">RefundAmount : </label>
                                        </div>
