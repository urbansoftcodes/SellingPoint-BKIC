<%@ Page Title="" Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="HomeInsurancePage.aspx.cs" Inherits="BKIC.SellingPoint.Presentation.HomeInsurancePage" %>
                            ...
                            <div class="form-horizontal form-label-left col-md-12">
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="col-md-6 page-label form-grid-3-input">
                                        <asp:TextBox ID="txtHomePolicySearch" runat="server" CssClass="form-control" autocomplete="off" Width="300" />
                                        <%--<asp:HiddenField ID="renewalCount" runat="server" />--%>
                                    </div>
                                </div>
                                <div class="form-group col-md-4">
                                    <div class="col-md-12 pull-left form-grid-3-btn form-grid-3-btn-small">
                                        <asp:Button ID="btnPolicy" runat="server" Text="Review" CssClass="btn btn-primary" OnClientClick="showPageLoader();" OnClick="btnPolicy_Click" ValidationGroup="PolicyCheck" />
                                    ...
                                    <div class="form-group col-md-4">
                                        <div class="col-md-12 page-button-wrap form-grid-3-btn form-grid-3-btn-right">
                                            <asp:Button ID="linkButton" type="button" Text="Add Insured" CssClass="btn btn-info btn-link-button" runat="server" OnClick="insured_Master" CausesValidation="false" />
                                        </div>
                                    </div>                           
                                <div class="clearfix"></div>
                                ...
                                <div>
                                    <div class="form-group col-md-4">
                                       ...
                                       <div class="col-md-6 page-label form-grid-3-input">
                                        ...
                                        <asp:RequiredFieldValidator ID="rfvtxtCPRSearch" CssClass="err" ErrorMessage="Please select CPR" SetFocusOnError="true" ControlToValidate="txtCPRSearch" runat="server" ValidationGroup="HomeCalculationValidation" />
                                    </div>
                                    </div>    
                                    <div class="form-group col-md-4">
                                        <div class="col-md-6 page-label form-grid-3-label">
                            ...
                            <div class="x_content">
                                ...
                                <div class="form-group">
                                    <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                        ...
                                        <asp:HiddenField ID="formHomeCalulated" Value="false" runat="server" />
