<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorChangeRegistrationEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorChangeRegistrationEndorsement" %>
                    ...
                    <div runat="server" id="mainDiv">
                        ...
                        <div class="chgreg_type typ_wrapper" id="ChangeRegistrationNoDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">Old Registration No :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtOldRegistrationNo" runat="server" CssClass="form-control col-md-10" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtOldRegistrationNo" ErrorMessage="Please enter old registration number" ControlToValidate="txtOldRegistrationNo" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtNewRegistrationNo" runat="server" CssClass="form-control col-md-10 onlynumber" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtNewRegistrationNo" ErrorMessage="Please enter new registration number" ControlToValidate="txtNewRegistrationNo" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
