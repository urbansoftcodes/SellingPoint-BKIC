<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="TravelChangePremiumEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.TravelChangePremiumEndorsement" %>
        ...
        <ContentTemplate>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div class="bank_type typ_wrapper" id="ChangePremiumDiv" runat="server">
                        <div class="form-horizontal form-label-left col-md-12">
                            <div class="form-group col-md-6" id="divActualPremium" runat="server">
                                <div class="col-md-4 page-label">
                                    <label class="control-label">Policy Premium :</label>
                                </div>
                                <div class="col-md-8 page-control">
                                    <asp:TextBox ID="txtActualPremium" runat="server" CssClass="form-control" Enabled="false" />
                                </div>
                            </div>
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-8 page-control">
                                    <asp:TextBox ID="txtNewPremium" runat="server" CssClass="form-control onlynumber" AutoPostBack="true" OnTextChanged="NewPremiun_Changed" />
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group col-md-6">
                    ...
                    <div class="dsc-overallwrapper" id="includeDisc" runat="server" visible="false">
                        <div class="dsc-wrapper">
                            ...
                            <div class="form-group col-md-10">
                                ...
                                <div class="col-md-7 page-control">
                                    <div class="control-label">
                                        <asp:TextBox ID="premiumAmount" Enabled="false" onChange="showPageLoader();" OnTextChanged="Premium_Changed" AutoPostBack="true" runat="server" CssClass="form-control col-md-10 onlynumber"></asp:TextBox>
                                    </div>
                                </div>
                            ...
                            <div class="form-group col-md-10">
                                ...
                                <div class="col-md-7 page-control">
                                    <div class="control-label">
                                        <asp:TextBox ID="commission" Enabled="false" onChange="showPageLoader();" OnTextChanged="Commission_Changed" AutoPostBack="true" runat="server" CssClass="form-control col-md-10 onlynumber"></asp:TextBox>
                                    </div>
                                </div>
                                <div class="col-md-1"></div>
                            </div>
