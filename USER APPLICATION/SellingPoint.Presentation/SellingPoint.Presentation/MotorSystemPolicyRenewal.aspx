<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorSystemPolicyRenewal.aspx.cs" Inherits="SellingPoint.Presentation.MotorSystemPolicyRenewal" %>
        ...
        <asp:UpdatePanel runat="server" ID="upnlHomeInsurance">
            <ContentTemplate>
                <div class="page-header">
                    ...
                    <div class="x_panel">
                        <div class="x_title">
                            <h2>Motor  Renewal Policy Search :</h2>
                            ...
                            <div class="form-group col-md-6">
                                    ...
                                    <asp:TextBox ID="txtMotorRenewalPolicySearch" runat="server" CssClass="form-control" autocomplete="off" Width="300"/> 
                                ...
                                <div class="form-horizontal form-label-left col-md-12">
                                    ...
                                    <div class="form-group">
                                        <div class="col-md-12 col-sm-12 col-xs-12 text-center">
                                            ...
                                            <a runat="server" id="downloadproposal" class="btn btn-primary" title="Proposal" onclick="btnPrint_Click"><i class="fa fa-download" aria-hidden="true"></i>Proposal</a>
                                ...
                                <div class="modal" id="newWarning">
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" runat="server" id="modelDiv2"> 
                                                This policy already moved into new System! Are you sure want to view?"
                                            </div>
                                            <div class="modal-footer">
                                                <asp:Button ID="Button1" type="button" Text="Yes" OnClientClick="showPageLoader();" OnClick="LoadAgencyPolicy" runat="server" CssClass="btn btn-primary" />                                               
                                                <asp:Button ID="Button3" type="button" OnClientClick="showPageLoader();" OnClick="LoadOraclePolicy" Text="No" runat="server" CssClass="btn btn-primary" />
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
