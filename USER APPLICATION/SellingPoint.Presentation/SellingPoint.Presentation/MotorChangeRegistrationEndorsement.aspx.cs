...
{
    public partial class MotorChangeRegistrationEndorsement : System.Web.UI.Page
    {
        ...
        public MotorChangeRegistrationEndorsement()
        {
        ...
        private void UpdatePolicyDetails(string DocumentNo, string RenewalCount, bool SearchByDocument)
        {
            ...
            if (motorDetails.StatusCode == 200 && motorDetails.Result.IsTransactionDone)
            {
                ...
                txtOldRegistrationNo.Text = response.RegistrationNumber;
                txtOldRegistrationNo.Enabled = false;
                IsCancelled(response.IsCancelled);
                if (string.IsNullOrEmpty(response.RegistrationNumber) && !response.IsCancelled)
                {
                    btnCalculate.Visible = false;
                    btnSubmit.Visible = true;
                    rfvtxtOldRegistrationNo.Enabled = false;
                ...
                else if (!response.IsCancelled)
                {
                    ...
                    btnSubmit.Visible = false;
                    rfvtxtOldRegistrationNo.Enabled = true;
        ...
        {            
            ...
            if (string.IsNullOrEmpty(txtNewRegistrationNo.Text))
            {
                master.ShowErrorPopup("Please enter new registration number !!", "Change Registration");
                return;
            }
            ...
            motorEndorementQuote.EndorsementType = "ChangeRegistrationNo";
            motorEndorementQuote.CancelationDate = DateTime.Now;
            ...
            if (motorEndoQuoteResult.StatusCode == 200 && motorEndoQuoteResult.Result.IsTransactionDone)
            {
                ...
                if (product != null)
                {
                    var mEndorsement = product.MotorEndorsementMaster.Find(c => c.EndorsementType == "ChangeRegistrationNo");
        ...
        public void ShowPremium(OAuthTokenResponse userInfo, decimal Premium, decimal Commission)
        {
            ...
            {
                //if (userInfo.Roles == BKIC.SellingPoint.DL.Constants.Roles.BranchAdmin)
                //{
        ...
        public void SetEndorsementType(BKIC.SellingPoint.DTO.RequestResponseWrappers.MotorEndorsement mtorEndorsement, BKIC.SellingPoint.DTO.RequestResponseWrappers.MotorInsurancePolicy mtorPolicyDetails)
        {
            ...
            mtorEndorsement.EndorsementType = "ChangeRegistrationNo";
