<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="TravelAddRemoveMemberEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.TravelAddRemoveMemberEndorsement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function DeleteMember() {
            var isDelete = confirm("Are you sure want to delete this member ?")
            if (isDelete) {
                showPageLoader();
                return true;
            }
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Occupation">
                                            <ItemTemplate>
                                                ...
                                                <asp:RequiredFieldValidator CssClass="err" ErrorMessage="Please enter occupation" ControlToValidate="txtOccupation" runat="server" ValidationGroup="travelValidation" Enabled="false" />
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="Action">
                                            <ItemTemplate>
