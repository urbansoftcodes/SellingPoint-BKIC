...
{
    public partial class MotorCancelEndorsement : System.Web.UI.Page
    {
        ...
        public void SaveAuthorize(bool isSave)
        {
            try
            {
                ...
                var postMotorEndorsement = new BKIC.SellingPoint.DTO.RequestResponseWrappers.MotorEndorsement
                {
                    ...
                    RefundType = ddlRefundType.SelectedItem.Text.Trim()
                };
                ...
                //    var diff = postMotorEndorsement.PremiumBeforeDiscount - postMotorEndorsement.PremiumAfterDiscount;
