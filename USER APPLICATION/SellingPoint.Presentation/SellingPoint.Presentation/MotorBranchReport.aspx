<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.master" CodeBehind="MotorBranchReport.aspx.cs"
    Inherits="BKIC.SellingPoint.Presentation.MotorBranchReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel-body">
        <div class="adv-table editable-table">
            <asp:GridView ID="gvMotorBranchReport" runat="server" CssClass="table table-bordered"
