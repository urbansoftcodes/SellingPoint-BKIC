...
{
    public partial class MotorExtentEndorsement : System.Web.UI.Page
    {
        ...
        private void UpdatePolicyDetails(string DocumentNo, string RenewalCount, bool SearchByDocument)
        {
            ...
            if (motorDetails.StatusCode == 200 && motorDetails.Result.IsTransactionDone)
            {
                ...
                txtEffectiveFromDate.Text = response.ExpiryDate.AddDays(1).CovertToLocalFormat();// response.PolicyCommencementDate.CovertToLocalFormat();
                txtEffectiveToDate.Text = response.ExpiryDate.AddDays(1).CovertToLocalFormat();
                ...
                extendStartDate.Value = response.ExpiryDate.AddDays(1).CovertToLocalFormat();
                master.SetExtendDate();
        ...
        public void SetEndorsementType(BKIC.SellingPoint.DTO.RequestResponseWrappers.MotorEndorsement mtorEndorsement, BKIC.SellingPoint.DTO.RequestResponseWrappers.MotorInsurancePolicy mtorPolicyDetails)
        {
            ...
            mtorEndorsement.PolicyCommencementDate = mtorPolicyDetails.ExpiryDate.AddDays(1);
            ...
            mtorEndorsement.EndorsementType = "Extended";
