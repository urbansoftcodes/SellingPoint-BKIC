<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorCancelEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorCancelEndorsement" %>
                    ...
                    <div class="form-horizontal form-label-left col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-md-8 page-control">
                                ...
                                <asp:RequiredFieldValidator InitialValue="-1" ID="rfvddlRefundType" ErrorMessage="Please select refund type" ControlToValidate="ddlRefundType" runat="server" ValidationGroup="MotorEndorsementValidation" />
                            </div>
                        </div>
                        <div>
                        </div>
                        ...
                        <div class="trf_type typ_wrapper" id="commonDiv" runat="server">
                            ...
                            <div class="form-horizontal form-label-left col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtEffectiveToDate" runat="server" AutoPostBack="true" OnTextChanged="Changed_CancelDate" CssClass="form-control col-md-10 cancel-date" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
