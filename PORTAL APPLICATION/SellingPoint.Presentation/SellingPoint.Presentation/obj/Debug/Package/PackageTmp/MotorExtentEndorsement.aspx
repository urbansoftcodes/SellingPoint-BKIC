<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorExtentEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorExtentEndorsement" %>
    ...
    <asp:UpdatePanel runat="server" ID="motorEndorsementUpdatePanel">
        <ContentTemplate>
                ...
                <div class="x_content">
                    ...
                    <div runat="server" id="mainDiv">
                        <div class="trf_type typ_wrapper" id="commonDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6" id="divEffectiveFrom" runat="server">
                                    <div class="col-md-4 page-label">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtEffectiveToDate" runat="server" CssClass="form-control col-md-10 extend-date" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
            ...
            <div class="btn-wrap-row text-center">
                ...
                <asp:HiddenField ID="extendStartDate" runat="server" />
