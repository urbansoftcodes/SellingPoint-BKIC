<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="HomeCancelEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.HomeCancelEndorsement" %>
                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            ...
                            <div class="col-md-8 page-control">
                                <asp:DropDownList ID="ddlRefundType" AutoPostBack="true" runat="server" OnSelectedIndexChanged="RefundType_Changed" CssClass="form-control col-md-10 chzn-select">
                                    <asp:ListItem Text="Select" Value="-1" />
                                    <asp:ListItem>Full Amount</asp:ListItem>
                                    <asp:ListItem>Pro Rate</asp:ListItem>
                                </asp:DropDownList>
                                <asp:RequiredFieldValidator InitialValue="-1" ID="rfvddlRefundType" ErrorMessage="Please select refund type" ControlToValidate="ddlRefundType" runat="server" ValidationGroup="HomeEndorsementValidation" />
                            </div>
                        </div>
                        <div>
                        </div>
                        ...
                        <div class="trf_type typ_wrapper" id="commonDiv" runat="server">
                            ...
                            <div class="form-horizontal form-label-left col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtEffectiveToDate" AutoPostBack="true" runat="server" OnTextChanged="Changed_CancelDate" CssClass="form-control col-md-10 cancel-date" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
