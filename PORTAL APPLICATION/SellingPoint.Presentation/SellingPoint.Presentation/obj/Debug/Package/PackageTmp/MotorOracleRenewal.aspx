<%@ Page Language="C#" MasterPageFile="~/General.Master" AutoEventWireup="true" CodeBehind="MotorOracleRenewal.aspx.cs" Inherits="SellingPoint.Presentation.MotorOracleRenewal" %>
                            ...
                            <div class="form-horizontal form-label-left col-md-12">
                                    ...
                                    <div class="col-md-6 page-label form-grid-3-label">
                                            ...
                                            <div class="col-md-6 page-label form-grid-3-input">
                                                <asp:TextBox ID="txtMotorOracleRenewalPolicySearch" runat="server" CssClass="form-control" autocomplete="off" Width="300"/> 
                                    ...
                                    <div class="modal-dialog">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body" runat="server" id="modelDiv2"> 
                                                This policy already moved into new System!.
                                            </div>
                                            <div class="modal-footer">
                                                <asp:Button ID="Button1" type="button" Text="OK" OnClientClick="CloseInfoPopup();" runat="server" CssClass="btn btn-primary" />
                                            </div>
                                        </div>
                                        <!-- /.modal-content -->
                                    </div>
