<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorAddCoverEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorAddCoverEndorsement" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <script>
        ...
        function DeleteCover() {
            var isDelete = confirm("Are you sure want to delete this cover ?")
            if (isDelete) {
                showPageLoader();
                return true;
            }
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    ...
                    <div runat="server" id="mainDiv">
                            ...
                            <div class="form-group col-md-12 append-rows">
                                ...
                                <div class="table-append-rows">
                                    <asp:GridView ID="Gridview1" Width="100%" OnRowDataBound="Gridview1_RowDataBound"
                                        OnRowDeleting="Gridview1_RowDeleting" runat="server" ShowFooter="true" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Cover Code">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlCover" runat="server" AutoPostBack="true" Enabled="false">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cover Description">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCoverDescription" runat="server" Enabled="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Cover Amount">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtCoverAmount" runat="server" Enabled="false"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="IsEndorsementCover" Visible="false">
                                                <ItemTemplate>
                                                    <asp:Label ID="lblAddedByEndorsement" runat="server"></asp:Label>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkbtnCoverDelete" runat="server" ToolTip="Delete" OnClientClick="return DeleteCover();" CssClass="fsize fcolorred" CommandName="Delete"><i class="fa  fa-trash-o"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
                        ...
                        <asp:Button ID="ButtonAddNewCover" runat="server" Text="Add New Cover" OnClientClick="showPageLoader();" OnClick="ButtonAddNewCover_Click" CssClass="btn btn-primary" />
                        <div id="newadmindetails" runat="server">
                            <div class="form-group col-md-12 append-rows">
                                <h2>New Cover details:</h2>
                                <div class="table-append-rows">
                                    <asp:GridView ID="Gridview2" Width="100%" OnRowDeleting="Gridview2_RowDeleting" OnRowDataBound="Gridview2_RowDataBound" runat="server" ShowFooter="true" AutoGenerateColumns="false">
                                        <Columns>
                                            <asp:TemplateField HeaderText="Cover Code">
                                                <ItemTemplate>
                                                    <asp:DropDownList ID="ddlNewCover" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCover_Changed">
                                                    </asp:DropDownList>
                                                </ItemTemplate>
                                            ...
                                            <asp:TemplateField HeaderText="Cover Amount">
                                                <ItemTemplate>
                                                    <asp:TextBox ID="txtNewCoverAmount" AutoPostBack="true" OnTextChanged="NewCoverAmount_Changed" CssClass="onlynumber" runat="server"></asp:TextBox>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="Action">
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="lnkbtnDelete" runat="server" ToolTip="Delete" OnClientClick="return DeleteCover();" CssClass="fsize fcolorred" CommandName="Delete"><i class="fa  fa-trash-o"></i></asp:LinkButton>
                                                </ItemTemplate>
                                            </asp:TemplateField>
                                        </Columns>
                                    </asp:GridView>
