<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.master" CodeBehind="HomeMainReport.aspx.cs"
    Inherits="SellingPoint.Presentation.HomeMainReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel-body">
        <div class="adv-table editable-table">
            <asp:GridView ID="gvHomeMainReport" runat="server" CssClass="table table-bordered"
