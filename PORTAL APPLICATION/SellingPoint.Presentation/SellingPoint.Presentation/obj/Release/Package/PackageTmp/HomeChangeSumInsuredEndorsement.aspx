<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="HomeChangeSumInsuredEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.HomeChangeSumInsuredEndorsement" %>
       ...
       <%--                <asp:HiddenField  ID="renewalCount"  runat="server"  />--%>
                    ...
                    <div runat="server" id="mainDiv">
                        ...
                        <div class="bank_type typ_wrapper" id="ChangeSumInsuredDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">Old SumInsured :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtOldBuildingSumInsured" runat="server" CssClass="form-control" Enabled="false" />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtNewBuildingSumInsured" runat="server" CssClass="form-control onlynumber" AutoPostBack="true" OnTextChanged="Changed_BuildingSumInsured" onChange="showPageLoader();" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        ...
                        <div class="form-horizontal form-label-left col-md-12">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="col-md-8 page-control">
                                    <asp:TextBox ID="txtOldContentSumInsured" runat="server" CssClass="form-control" Enabled="false" />
                                </div>
                            </div>
                            <div class="form-group col-md-6">
                                <div class="col-md-4 page-label">
                                ...
                                <div class="col-md-8 page-control">
                                    <asp:TextBox ID="txtNewContentSumInsured" runat="server" CssClass="form-control onlynumber" AutoPostBack="true" OnTextChanged="Changed_ContentSumInsured" onChange="showPageLoader();" />
                                </div>
                            </div>
                            <div class="clearfix"></div>
                            <div class="form-group col-md-6">
            ...
            <div class="x_content">
                ...
                <div class="btn-wrap-row text-center">
                    <asp:Button ID="btnCalculate" runat="server" Text="Calculate" CssClass="btn btn-primary" OnClientClick="showPageLoader('HomeEndorsementValidation');" OnClick="Calculate_Click" />
                    ...
                    <asp:HiddenField ID="maxBuildingValue" runat="server" />
                    <asp:HiddenField ID="maxContentValue" runat="server" />
