<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.master" CodeBehind="MotorMainReport.aspx.cs" 
    Inherits="SellingPoint.Presentation.MotorMainReport" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="panel-body">
        <div class="adv-table editable-table">
            <asp:GridView ID="gvMotorMainReport" runat="server" CssClass="table table-bordered"
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="AuthorizedDate" HeaderText="Authorized Date" SortExpression="CreatedDate" HeaderStyle-ForeColor="White" />                   
