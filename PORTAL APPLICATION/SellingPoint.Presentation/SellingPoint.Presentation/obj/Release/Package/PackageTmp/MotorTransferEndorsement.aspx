<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/General.Master" CodeBehind="MotorTransferEndorsement.aspx.cs" Inherits="SellingPoint.Presentation.MotorTransferEndorsement" %>
    ...
    <asp:UpdatePanel runat="server" ID="motorEndorsementUpdatePanel">
        <ContentTemplate>
            ...
            <div class="x_panel">
                ...
                <div class="x_content">
                    <div class="form-horizontal form-label-left col-md-12">
                        ...
                        <div class="form-group col-md-4">
                            <div class="col-md-4 page-label">
                                <label class="control-label">NewInsured CPR: *</label>
                            </div>
                            <asp:TextBox ID="txtCPRSearchNew" runat="server" CssClass="form-control onlynumber" autocomplete="off" Width="300" AutoPostBack="true" OnTextChanged="ChangedNewInsured_CPR" onChange="showPageLoader();"/>
                            <asp:RequiredFieldValidator ID="rfvtxtCPRSearchNew" CssClass="err" ErrorMessage="Please select new CPR" SetFocusOnError="true" ControlToValidate="txtCPRSearchNew" runat="server" ValidationGroup="MotorEndorsementValidation" />
                         
                        </div>                        
                        <div class="col-md-2 page-control pull-right">
                            <asp:Button ID="linkButton" type="button" Text="Add Insured" CssClass="btn btn-info btn-link-button" runat="server" OnClick="insured_Master" Style="width: 100%;" />
                        </div>                       
                        <div>
                        </div>
                        <div class="clearfix"></div>
                    ...
                    <div runat="server" id="mainDiv">
                        <div class="trf_type typ_wrapper" id="commonDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                ...
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">Old Insured code :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtOldClientCode" runat="server" CssClass="form-control col-md-10" Enabled="false" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtOldClientCode" ErrorMessage="Please enter old insured code" ControlToValidate="txtOldClientCode" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>

                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">Old Insurance Name :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtOldInsuredName" runat="server" CssClass="form-control col-md-10" Enabled="false" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtOldInsuredName" ErrorMessage="Please enter old insured code" ControlToValidate="txtOldInsuredName" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                            </div>
                        </div>
                        <div class="trf_type typ_wrapper" id="transferDiv" runat="server">
                            <div class="form-horizontal form-label-left col-md-12">
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">New client code :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtNewClientCode" runat="server" CssClass="form-control col-md-10" Enabled="false" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtNewClientCode" ErrorMessage="Please enter new insured code" ControlToValidate="txtNewClientCode" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                    ...
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtNewInsuredName" runat="server" CssClass="form-control col-md-10" Enabled="false" />
                                        <asp:RequiredFieldValidator CssClass="err" SetFocusOnError="true" ID="rfvtxtNewInsuredName" ErrorMessage="Please enter new insured name" ControlToValidate="txtNewInsuredName" runat="server" ValidationGroup="MotorEndorsementValidation" />
                                    </div>
                                </div>
                                <div class="form-group col-md-6">
                                    <div class="col-md-4 page-label">
                                        <label class="control-label">New Insured Age :</label>
                                    </div>
                                    <div class="col-md-8 page-control">
                                        <asp:TextBox ID="txtInsuredAge" runat="server" CssClass="form-control col-md-10" Enabled="false" />
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                <div class="form-group col-md-6">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8">
                                <div class="control-label page-control">
                                    <asp:DropDownList ID="ddlPaymentMethods" runat="server" CssClass="form-control col-md-10 chzn-select" AutoPostBack="True" OnSelectedIndexChanged="ddlPaymentMethod_SelectedIndexChanged" TabIndex="30">
                        ...
                        <div class="form-group col-md-6">
                            ...
                            <div class="col-md-8 page-control">
                                <div class="control-label ">
                                    <asp:TextBox ID="txtAccountNumber" runat="server" CssClass="form-control col-md-10" TabIndex="31" />
            ...
            <div class="btn-wrap-row text-center">
                ...
                <asp:HiddenField ID="sumInsured" runat="server" />
