...
{
    public partial class HomeHIR : System.Web.UI.Page
    {
        ...
        public void QueryStringMethods(OAuthTokenResponse userInfo, DataServiceManager service)
        {
            ...
            if (policyNo != null)
            {
                ...
                txtHomePolicy.Text = Convert.ToString(policyNo);
                GetPolicyInfo();
            }
        }
        ...
        protected void Calculate_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {      
                    ...
                    homeQuote.RenewalDelayedDays = string.IsNullOrEmpty(actualRenewalDate.Value) ? 0 : (int)(txtInsurancePeriodFrom.Text.CovertToCustomDateTime() - actualRenewalDate.Value.CovertToCustomDateTime()).TotalDays;
        ...
        public void GetPolicyInfo()
        {
            try
            {
                ...
                var docNo = txtHomePolicy.Text.Trim();
        ...
        private void Update(OAuthTokenResponse userInfo, ApiResponseWrapper<HomeSavedQuotationResponse> homeDetails)
        {
            ...
            actualRenewalDate.Value = res.ActualRenewalStartDate.ConvertToLocalFormat();
            ...
            SetData(userInfo, homeDetails, res);
        }

        private void SetData(OAuthTokenResponse userInfo, ApiResponseWrapper<HomeSavedQuotationResponse> homeDetails, HomeInsurancePolicy res)
        {
            ...
            {
                SetScheduleHRef(txtHomePolicy.Text.Trim(), Constants.Home, userInfo, res.RenewalCount);
        ...
        public void SaveAuthorize(bool isSave)
        {
            ...
            {                
                ...
                if (homeQuoteResult.StatusCode == 200 && homeQuoteResult.Result.IsTransactionDone)
                {
                    ...
                    homepolicy.HomeInsurancePolicy.IsRenewal = _RenewalCount > 0;                   
                ...
                if (_RenewalCount > 0)
                    homepolicy.HomeInsurancePolicy.RenewalCount = _RenewalCount - 1;
                ...
                homepolicy.HomeInsurancePolicy.DocumentNo = txtHomePolicy.Text.Trim();
                ...
                if (postData != null && postData.StatusCode == 200 && postData.Result.IsTransactionDone)
                {
                    _HomeID = postData.Result.HomeId;
                     txtHomePolicy.Text = postData.Result.DocumentNo;
